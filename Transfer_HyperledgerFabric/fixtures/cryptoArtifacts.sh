...
CHANNEL_NAME=$1
: ${CHANNEL_NAME:="zhongyuanzhongcheng"}
echo $CHANNEL_NAME
...
function generateChannelArtifacts() {
	...
	#$CONFIGTXGEN -profile OneOrgOrdererGenesis -channelID zhongyuanzhongcheng -outputBlock ./artifacts/genesis.block
    ...
    $CONFIGTXGEN -profile OneOrgChannel -outputAnchorPeersUpdate ./artifacts/Org1MSPanchors.tx -channelID $CHANNEL_NAME -asOrg AcompanyOrg
