...
func GetAllPlainEquipment(stub shim.ChaincodeStubInterface) peer.Response {
...
func GetAllPlainEquipmentWithPagination(stub shim.ChaincodeStubInterface, args []string) peer.Response {
	...
	fmt.Printf("- GetAssetEquipmentByRangeWithPagination queryResult:\n%s\n", bufferWithPaginationInfo.String())
